...
<?php include("../../php-includes/02.favicon.php"); ?>
		...
		<title>College Works Painting - About Us - Our Values</title>
		...
		<meta name="description" content="College Works Painting is guided by these core values: Relationships are everything, One must earn the right to work here, The four referability habits, Results economy, Work hard, play hard, have fun, Balance:  it is the real measure of success, Growth in existing and new ventures">
...
<?php $current = 4; $subCurrent = 42; include("../../php-includes/06.menubar.php"); ?>

<?php include("../../php-includes/07.mainer/values.php"); ?>
